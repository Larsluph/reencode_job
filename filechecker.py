...
class FileCheckError(Flag):
    ...
    # Combined errors
    NONE = 0
    ALL_AUDIO = AUDIO_CODEC | AUDIO_SAMPLE_RATE | AUDIO_CHANNELS | AUDIO_BITRATE
    ALL_VIDEO = VIDEO_CODEC | VIDEO_RESOLUTION | VIDEO_FPS | VIDEO_BITRATE
    ALL = ALL_AUDIO | ALL_VIDEO
